namespace SteveBagnall.Etl.EtlForexTests
{
	...
	public class ManifestTests
	{
		...
		[TestMethod]
		public void Test_GetLastFormatObject_NoStoreExists()
		{
		...
		[TestMethod]
		public void Test_GetLastFormatObject_StoreExistsWrongSourceName()
		{
			DataTable dt = CreateDataTable("manifest");
			
			DataRow dr = dt.NewRow();
			UpdateRow(dr, new FormatObject("test1", new DateTime(2003, 1, 1)));
			dt.Rows.Add(dr);
		...
		[TestMethod]
		public void Test_GetLastFormatObject_StoreExists()
		{
			DataTable dt = CreateDataTable("test");

			DataRow dr = dt.NewRow();
			UpdateRow(dr, new FormatObject("test", new DateTime(2003, 1, 1)));
			dt.Rows.Add(dr);
